(function (window) {
  ...
  utils.getMetaOptions = function (el, name, metadata) {
    ...
    try {
      ...
      if (console) {
        console.error(
          "Error parsing " + dataAttr + " on " + el.className + ": " + error,
        );
      }
      return;
    }
...
(function (w, $) {
  ...
  var TrapTabKey = (w.componentNamespace.TrapTabKey = function (
    element,
    options,
  ) {
    if (!element) {
  ...
  TrapTabKey.prototype.giveFocus = function () {
    ...
    focusEl.length
      ? focusEl.first().focus()
      : o
          .filter(opts.focusableElementsString)
          .filter(":visible")
          .first()
          .focus();
  };
...
(function (window, $) {
  ...
  Button.prototype._create = function () {
    ...
    if (options.icon) {
      this.$buttonIcon = $(
        "<span class='" +
          options.iconFamily +
          " " +
          utils.createModifierClass(options.iconFamily, options.icon) +
          "'></span>",
      ).prependTo(this.$element);
      this._buttonClasses.push(
        utils.createModifierClass(options.baseClass, cl.withIcon),
      );

      if (options.iconActive) {
        options.toggle = true;
        this.$buttonIconActive = $(
          "<span class='" +
            options.iconFamily +
            " " +
            utils.createModifierClass(options.iconFamily, options.iconActive) +
            " " +
            utils.createModifierClass(options.iconFamily, cl.showHide) +
            "'></span>",
        ).insertAfter(this.$buttonIcon);
        this._buttonClasses.push(
          utils.createModifierClass(options.baseClass, cl.toggleState),
        );
      }
      if (options.hideText) {
        buttonTextClasses.push(utils.classes.hiddenVisually);
        this._buttonClasses.push(
          utils.createModifierClass(options.baseClass, cl.iconOnly),
        );
      }
    }
    ...
    if (options.textActive && options.wrapText) {
      options.toggle = true;
      buttonTextClasses.push(
        utils.createModifierClass(options.baseClass + "__text", cl.showHide),
      );
      this._buttonClasses.push(
        utils.createModifierClass(options.baseClass, cl.toggleState),
      );
  ...
  Button.prototype._isPressed = function (state) {
    ...
    this.$element
      ...
      [state ? "addClass" : "removeClass"](utils.classes.isActive);
  };
...
(function (w, $) {
  ...
  $(document).bind("enhance", function (e) {
    $($(e.target).is(initSelector) && e.target)
      .add(initSelector, e.target)
      .filter(initSelector)
      [pluginName]();
  });
})(this, jQuery);
...
(function (window, $) {
  ...
  var Offcanvas = (window.componentNamespace.Offcanvas = function (
    element,
    options,
  ) {
    if (!element) {
    ...
    if (!window.utils.supportTransition) {
      this._panelClasses.push(
        utils.createModifierClass(
          options.baseClass,
          options.supportNoTransitionsClass,
        ),
      );
    }
    utils.cssModifiers(
  ...
  Offcanvas.prototype.open = function () {
    ...
    if (!this.isOpen) {
      ...
      if (options.modal) {
        ...
        this.$modal.addClass(
          utils.createModifierClass(options.modalClass, "opening"),
        );
      }
      ...
      utils.onEndTransition(this.transitionElement, function () {
        ...
        if (options.modal) {
          ...
          self.$modal.removeClass(
            utils.createModifierClass(options.modalClass, "opening"),
          );
        }
        self.$element.removeClass(
          utils.createModifierClass(options.baseClass, "opening"),
        );
      });
      if (this.$trigger) {
  ...
  Offcanvas.prototype.close = function () {
    ...
    if (this.options.modal) {
      this._addClasses(this.$modal, this.isOpen, true);
      this.$modal.addClass(
        utils.createModifierClass(options.modalClass, "closing"),
      );
    }
    ...
    utils.onEndTransition(this.transitionElement, function () {
      ...
      self.$element.removeClass(
        utils.createModifierClass(options.baseClass, "closing"),
      );
  ...
  Offcanvas.prototype._addClasses = function (el, isOpen, beforeTransition) {
    if (isOpen) {
      if (beforeTransition) {
        el.removeClass(utils.classes.isClosed)
      ...
      if (beforeTransition) {
        el.removeClass(utils.classes.isOpen).addClass(
          utils.classes.isAnimating,
        );
      } else {
        el.addClass(utils.classes.isClosed).removeClass(
          utils.classes.isAnimating,
        );
      }
    }
  ...
  Offcanvas.prototype._initTrigger = function () {
    ...
    if (options.triggerButton) {
      ...
      new window.componentNamespace.OffcanvasTrigger(this.$triggerBtn[0], {
        offcanvas: offcanvasID,
      }).init();
    }
  };
...
(function (w, $) {
  ...
  var OffcanvasTrigger = (w.componentNamespace.OffcanvasTrigger = function (
    element,
    options,
  ) {
    if (!element) {
  ...
  OffcanvasTrigger.prototype._create = function () {
    this.options.offcanvas =
      this.options.offcanvas || this.$element.attr("data-offcanvas-trigger");
