...
const uriAttributes = new Set([
  ...
  allowedAttribute = (r, a) => {
    ...
    return a.includes(t)
      ? uriAttributes.has(t)
        ? !!SAFE_URL_PATTERN.test(r.nodeValue)
        : !0
      : a.filter((e) => e instanceof RegExp).some((e) => e.test(t));
  };
...
((window.Joomla = window.Joomla || {}),
  ...
  ((r) => {
    ((r.extend = (t, e) => {
      ...
      (r.getOptions = (t, e) => (
        r.optionsStorage || r.loadOptions(),
        ...
        r.optionsStorage
          ? t &&
            [].slice.call(Object.keys(t)).forEach((e) => {
              t[e] !== null &&
              typeof r.optionsStorage[e] == "object" &&
              typeof t[e] == "object"
      ...
      (r.Text = {
        ...
        _: (t, e) => {
          ...
          return (
            l && (r.Text.load(l), r.loadOptions({ "joomla.jtext": null })),
            (n = n === void 0 ? s : n),
            (s = s.toUpperCase()),
      ...
      (r.checkAll = (t, e) => {
        ...
        return (
          n.forEach((i) => {
            i.type === t.type &&
              i.id.indexOf(s) === 0 &&
              ((i.checked = t.checked), (l += i.checked ? 1 : 0));
          }),
          t.form.boxchecked &&
            ((t.form.boxchecked.value = l),
      ...
      (r.isChecked = (t, e) => {
        ...
        if (
          (typeof s > "u"
            ...
            : typeof e == "string" && (s = document.getElementById(e)),
          (s.boxchecked.value = t
            ? parseInt(s.boxchecked.value, 10) + 1
            : parseInt(s.boxchecked.value, 10) - 1),
          s.boxchecked.dispatchEvent(
            new CustomEvent("change", { bubbles: !0, cancelable: !0 }),
          ),
      ...
      (r.tableOrdering = (t, e, s, n) => {
        ...
        (typeof l > "u"
          ...
          : typeof n == "string" && (l = document.getElementById(n)),
          (l.filter_order.value = t),
          (l.filter_order_Dir.value = e),
          r.submitform(s, l));
      }),
          ...
          s = (n, l) => {
            ...
            if (
              ...
              (i.onreadystatechange = () => {
                i.readyState === 4 &&
                  (i.status === 200
                    ? e.promise
                      ? n.call(window, i)
                      : n.call(window, i.responseText, i)
                    : l.call(window, i),
              ...
              if (e.onBefore && e.onBefore.call(window, i) === !1)
                return (e.promise && n.call(window, i), i);
              i.send(e.data);
            }
            return i;
          };
    ...
    ((r.enqueueRequest = (t) => {
      ...
      (r.sanitizeHtml = (t, e, s) => {
        const n =
          e == null ? DefaultAllowlist : _extends({}, DefaultAllowlist, e);
      ...
      (r.ajaxErrorsMessages = (t, e) => {
        ...
        if (e === "parsererror") {
          ...
          for (let i = l.length - 1; i >= 0; i--)
            n.unshift(["&#", l[i].charCodeAt(), ";"].join(""));
          ((l = n.join("")),
            (s.error = [
              r.Text._("JLIB_JS_AJAX_ERROR_PARSE").replace("%s", l),
            ]));
        } else
          e === "nocontent"
            ...
            : e === "timeout"
              ...
              : e === "abort"
                ...
                : t.responseJSON && t.responseJSON.message
                  ? (s.error = [
                      `${r.Text._("JLIB_JS_AJAX_ERROR_OTHER").replace("%s", t.status)} <em>${t.responseJSON.message}</em>`,
                    ])
                  : t.statusText
                    ? (s.error = [
                        `${r.Text._("JLIB_JS_AJAX_ERROR_OTHER").replace("%s", t.status)} <em>${t.statusText}</em>`,
                      ])
                    : (s.error = [
                        r.Text._("JLIB_JS_AJAX_ERROR_OTHER").replace(
                          "%s",
                          t.status,
                        ),
                      ]);
