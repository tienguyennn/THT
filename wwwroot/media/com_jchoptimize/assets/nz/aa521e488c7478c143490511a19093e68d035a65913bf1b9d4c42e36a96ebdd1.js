...
(function ($) {
  ...
  $(window).on("load", function () {
    scaleIconFollowScreen("ja-hotspot-image-1536", "ja-imagesmap1536");
    addHammerJS("ja-imagesmap1536", 5, 1);
    if ($("#ja-imagesmap1536 #cd-dropdown").hasClass("chzn-done"))
      $("#ja-imagesmap1536 #cd-dropdown").chosen("destroy");
    $("#ja-imagesmap1536 #cd-dropdown").jadropdown({ gutter: 0, stack: false });
    $("#ja-imagesmap1536 .cd-dropdown ul li").click(function () {
      target = $(this).attr("data-value");
      setTimeout(function () {
        WebuiPopovers.show("#ja-imagesmap1536 #" + target + " .bg");
      }, 100);
    });
    $("#ja-imagesmap1536 a.point").each(function () {
