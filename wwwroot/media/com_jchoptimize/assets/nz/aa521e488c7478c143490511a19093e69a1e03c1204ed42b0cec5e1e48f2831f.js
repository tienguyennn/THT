(function () {
  var h,
    ...
    x = function (i, t) {
      for (var e in t) k.call(t, e) && (i[e] = t[e]);
      function s() {
        this.constructor = i;
      }
      return (
  ...
  ((p = (function () {
    ...
    return (
      (i.prototype.add_node = function (t) {
        return t.nodeName.toUpperCase() === "OPTGROUP"
          ? this.add_group(t)
          : this.add_option(t);
      }),
      (i.prototype.add_group = function (t) {
        var e, s, r, l, n, o;
        for (
          ...
          ((l = n[s]), o.push(this.add_option(l, e, t.disabled)));
        return o;
      }),
      (i.prototype.add_option = function (t, e, s) {
        if (t.nodeName.toUpperCase() === "OPTION")
          return (
            t.text !== ""
              ? (e != null && (this.parsed[e].children += 1),
                this.parsed.push({
                  ...
                  group_array_index: e,
                  group_label: e != null ? this.parsed[e].label : null,
                  classes: t.className,
    ...
    (p.select_to_array = function (i) {
      var t, e, s, r, l;
      for (r = new p(), l = i.childNodes, e = 0, s = l.length; e < s; e++)
        ((t = l[e]), r.add_node(t));
      return r.parsed;
    }),
    (d = (function () {
      function i(t, e) {
        ((this.form_field = t),
          (this.options = e ?? {}),
          (this.label_click_handler = w(this.label_click_handler, this)),
          i.browser_is_supported() &&
      ...
      return (
            ...
            this.form_field.getAttribute("data-placeholder")
              ...
              : this.is_multiple
                ? (this.default_text =
                    ...
                    i.default_multiple_text)
                : (this.default_text =
                    this.options.placeholder_text_single ||
                    this.options.placeholder_text ||
                    i.default_single_text),
            (this.default_text = this.escape_html(this.default_text)),
            (this.results_none_found =
              this.form_field.getAttribute("data-no_results_text") ||
              this.options.no_results_text ||
              i.default_no_result_text)
          );
        }),
        (i.prototype.choice_label = function (t) {
          return this.include_group_label_in_selected && t.group_label != null
            ? "<b class='group-name'>" +
        ...
        (i.prototype.results_option_build = function (t) {
          var e, s, r, l, n, o, c;
          for (
            e = "", c = 0, o = this.results_data, l = 0, n = o.length;
            l < n &&
            ((s = o[l]),
            (r = ""),
            s.group
              ? (r = this.result_add_group(s))
              : (r = this.result_add_option(s)),
            r !== "" && (c++, (e += r)),
            t?.first &&
        ...
        (i.prototype.result_add_option = function (t) {
          ...
          return !t.search_match || !this.include_option_in_results(t)
            ...
            : ((e = []),
              ...
              t.group_array_index != null && e.push("group-option"),
        ...
        (i.prototype.reset_single_select_options = function () {
          var t, e, s, r, l;
          for (s = this.results_data, l = [], t = 0, e = s.length; t < e; t++)
            ((r = s[t]),
              r.selected ? l.push((r.selected = !1)) : l.push(void 0));
          return l;
        }),
        ...
        (i.prototype.winnow_results = function (t) {
          var e, s, r, l, n, o, c, b, y, g, a, m, u, v, f;
          for (
            this.no_results_clear(),
              g = 0,
              c = this.get_search_text(),
              e = c.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"),
              y = this.get_search_regex(e),
              b = this.results_data,
              r = 0,
              l = b.length;
            r < l;
            ...
            ((n = b[r]),
              ...
              this.include_option_in_results(n) &&
                ...
                n.group_array_index != null &&
                  ...
                  a.active_options === 0 && a.search_match && (g += 1),
                  (a.active_options += 1)),
                (f = n.group ? n.label : n.text),
                (n.group && !this.group_search) ||
                  ((m = this.search_string_match(f, y)),
                  (n.search_match = m != null),
                  n.search_match && !n.group && (g += 1),
                  n.search_match
                    ? (c.length &&
                        ((u = m.index),
                        (o = f.slice(0, u)),
                        (s = f.slice(u, u + c.length)),
                        (v = f.slice(u + c.length)),
                        (n.highlighted_html =
                          this.escape_html(o) +
                          "<em>" +
                          this.escape_html(s) +
                          "</em>" +
                          this.escape_html(v))),
                      a != null && (a.group_match = !0))
                    : n.group_array_index != null &&
                      this.results_data[n.group_array_index].search_match &&
                      (n.search_match = !0))));
          if ((this.result_clear_highlight(), g < 1 && c.length))
            return (this.update_results_content(""), this.no_results(c));
          if (
        ...
        (i.prototype.search_string_match = function (t, e) {
          ...
          return (
            (s = e.exec(t)),
            !this.search_contains && s?.[1] && (s.index += 1),
            s
          );
        }),
        (i.prototype.choices_count = function () {
          ...
          for (
            ...
            ((s = r[t]), s.selected && (this.selected_option_count += 1));
          return this.selected_option_count;
        }),
        ...
        (i.prototype.keydown_checker = function (t) {
          var e, s;
          switch (
            ((s = (e = t.which) != null ? e : t.keyCode),
            this.search_field_scale(),
            s !== 8 && this.pending_backstroke && this.clear_backstroke(),
            s)
          ) {
            case 8:
...
<div class="chosen-drop">
  ...
  ` +
    ...
    h.fn.extend({
      chosen: function (i) {
        return d.browser_is_supported()
          ? this.each(function (t) {
              var e, s;
              if (((e = h(this)), (s = e.data("chosen")), i === "destroy")) {
                s instanceof _ && s.destroy();
                return;
              }
              s instanceof _ || e.data("chosen", new _(this, i));
            })
          : this;
      },
    }),
    (_ = (function (i) {
      ...
      return (
        ...
        (t.prototype.destroy = function () {
          return (
            h(this.container[0].ownerDocument).off(
              "click.chosen",
        ...
        (t.prototype.container_mousedown = function (e) {
          ...
          if (
            !this.is_disabled &&
            (e &&
              ((s = e.type) === "mousedown" || s === "touchstart") &&
              !this.results_showing &&
              e.preventDefault(),
            !(e != null && h(e.target).hasClass("search-choice-close")))
          )
            return (
              this.active_field
                ? !this.is_multiple &&
                  e &&
                  (h(e.target)[0] === this.selected_item[0] ||
                    h(e.target).parents("a.chosen-single").length) &&
                  (e.preventDefault(), this.results_toggle())
                : (this.is_multiple && this.search_field.val(""),
                  h(this.container[0].ownerDocument).on(
                    "click.chosen",
                    this.click_test_action,
                  ),
                  this.results_show()),
        ...
        (t.prototype.search_results_mousewheel = function (e) {
          ...
          if (
            ...
            return (
              e.preventDefault(),
              e.type === "DOMMouseScroll" && (s = s * 40),
              this.search_results.scrollTop(s + this.search_results.scrollTop())
            );
        }),
        ...
        (t.prototype.test_active_click = function (e) {
          var s;
          return (
            (s = h(e.target).closest(".chosen-container")),
        ...
        (t.prototype.result_do_highlight = function (e) {
          ...
          if (e.length) {
            if (
              ...
              (s = r + this.result_highlight.outerHeight()),
              s >= n)
            )
              return this.search_results.scrollTop(s - l > 0 ? s - l : 0);
        ...
        (t.prototype.search_results_mouseup = function (e) {
          var s;
          if (
            ((s = h(e.target).hasClass("active-result")
              ? h(e.target)
              : h(e.target).parents(".active-result").first()),
            s.length)
          )
            return (
        ...
        (t.prototype.search_results_mouseout = function (e) {
          if (
            h(e.target).hasClass("active-result") ||
            h(e.target).parents(".active-result").first()
          )
        ...
        (t.prototype.choice_build = function (e) {
          var s, r;
          return (
            (s = h("<li />", { class: "search-choice" }).html(
            ...
            e.disabled
              ...
              : ((r = h("<a />", {
                ...
                r.on(
                  ...
                  (function (l) {
                    return function (n) {
                      return l.choice_destroy_link_click(n);
                    };
                  })(this),
                ),
                s.append(r)),
        ...
        (t.prototype.choice_destroy_link_click = function (e) {
          if ((e.preventDefault(), e.stopPropagation(), !this.is_disabled))
            return this.choice_destroy(h(e.target));
        }),
            ...
            return (
              ...
              this.max_selected_options <= this.choices_count()
                ? (this.form_field_jq.trigger("chosen:maxselected", {
                  ...
                  !1)
                : (this.is_multiple
                    ? s.removeClass("active-result")
                    : this.reset_single_select_options(),
                  s.addClass("result-selected"),
                  (r =
                    this.results_data[
                      s[0].getAttribute("data-option-array-index")
                    ]),
                  (r.selected = !0),
                  ...
                  this.is_multiple
                    ? this.choice_build(r)
                    : this.single_set_selected_text(this.choice_label(r)),
                  this.is_multiple &&
        ...
        (t.prototype.result_deselect = function (e) {
          var s;
          return (
            (s = this.results_data[e]),
            this.form_field.options[s.options_index].disabled
              ? !1
              : ((s.selected = !1),
                (this.form_field.options[s.options_index].selected = !1),
                (this.selected_option_count = null),
                this.result_clear_highlight(),
                this.results_showing && this.winnow_results(),
                this.trigger_form_field_change({
                  deselected: this.form_field.options[s.options_index].value,
                }),
                this.search_field_scale(),
                !0)
          );
        ...
        (t.prototype.search_field_scale = function () {
          ...
          if (this.is_multiple) {
            for (
              ...
              ((l = o[s]), (n[l] = this.search_field.css(l)));
            return (
              (e = h("<div />").css(n)),
              ...
              this.container.is(":visible") &&
                (c = Math.min(this.container.outerWidth() - 10, c)),
              this.search_field.width(c)
            );
          }
        }),
