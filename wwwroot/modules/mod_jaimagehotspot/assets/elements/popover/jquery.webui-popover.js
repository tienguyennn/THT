    ...
    WebuiPopover.prototype = {
      ...
      getElementPosition: function () {
        ...
        if (container.is(document.body) || cssPos === "static") {
          ...
          return {
            ...
            left:
              elRect.left - containerRect.left + jQuery(window).scrollLeft(),
            width: elRect.width,
      ...
      getTargetPositin: function (
        ...
        var pos = elementPos,
          ...
          scrollTop =
            document.documentElement.scrollTop + jQuery(window).scrollTop(),
          scrollLeft =
            document.documentElement.scrollLeft + jQuery(window).scrollLeft(),
          position = {},
          arrowOffset = null,
