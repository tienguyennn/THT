      ...
      inform: function (t, n, r) {
        ...
        for (var i = 0; i < o; i++) {
          ...
          try {
            ...
            a.require
              ? a.require("Arbiter").inform(t, n, r)
              : a.ServerJSAsyncLoader && a.ServerJSAsyncLoader.wakeUp(t, n, r);
          } catch (e) {}
        }
      },
    };
      ...
      l = (function () {
        function t(t) {
          ...
          ((this.$3 = t.getReader()),
            ...
            (this.$7 = new (e || (e = n("Promise")))(function (e, t) {
              r.$8 = e;
            })));
        }
        var r = t.prototype;
        return (
          ...
          (r.$13 = (function () {
            var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
              ...
              var t = yield this.$3.read(),
                n = t.done,
                r = t.value;
              return (
                (this.$4 = n),
                n && this.$8(),
                r ? this.$10().decode(r, { stream: !n }) : ""
              );
            });
            function t() {
          ...
          (r.readUntilStringOrThrow = (function () {
            var e = n("asyncToGeneratorRuntime").asyncToGenerator(
              function* (e) {
                if (!e) throw new Error("cannot read empty string");
                this.$11();
                for (var t = "", n = 0; !this.isDone(); )
                  if (((t += yield this.$13()), !(t.length < e.length))) {
                    var r = t.substring(n).indexOf(e);
                    if (r !== -1)
                      return (
                        (r += n),
                        (this.$6 = t.substring(r + e.length)),
                        this.$12(),
                        t.substring(0, r)
                      );
                    n = t.length - e.length + 1;
                  }
                throw (
                  (this.$6 = t),
                  this.$12(),
      ...
      u = (function (t) {
        ...
        return (
          ...
          (a.send = function () {
            ...
            var e = new Request(this.getRequestURI().toString(), {
              mode: "same-origin",
              credentials: "include",
            });
            ...
            var t = self.fetch(e, { redirect: "follow" });
            this.$FetchStreamTransport$p_7(t);
          }),
...
__d(
  ...
  function (t, n, r, o, a, i) {
    var e =
      ...
      l = !1,
      s = {
        REACT_ELEMENT_TYPE: e,
        injectReactShim: function (t) {
          var e = { validated: !0 };
          l
            ? Object.defineProperty(t, "_store", {
                configurable: !1,
                enumerable: !1,
                writable: !1,
                value: e,
...
__d(
  ...
  function (t, n, r, o, a, i) {
    function e(e) {
      return new (n("FbtPureStringResult"))(e.contents, e.errorListener);
    }
    a.exports = e;
  },
  null,
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    "use strict";
    var e = r("requireDeferred")("IntlQtEventFalcoEvent").__setRef(
      "translationOverrideListener",
    );
    function s(t) {
      ...
      access: function (n, r, o, a) {
        if (o >= r.length)
          return (
            typeof n == "string" ||
              Array.isArray(n) ||
              l(0, 21388, JSON.stringify(n)),
            n
          );
        var t = r[o],
          i = t[e.ARG.INDEX];
        if (i == null) return e.access(n, r, o + 1, a);
        (typeof n != "string" && !Array.isArray(n)) || l(0, 20954, typeof n);
...
__d(
  ...
  function (t, n, r, o, a, i) {
    "use strict";
    var e = {
      getEnumResult: function (t) {
        return [[t], null];
      },
      getGenderResult: function (t, n, r) {
        return [t, n];
      },
      getNumberResult: function (t, n, r) {
        return [t, n];
      },
      getSubstitution: function (t) {
        return [null, t];
      },
      getPronounResult: function (t) {
        return [[t, "*"], null];
      },
    };
    a.exports = e;
...
__d(
  ...
  function (t, n, r, o, a, i) {
    var e,
      ...
      u = {};
    function c(e) {
      return (u[e] || (u[e] = new RegExp(e, "i")), u[e]);
    }
    var d = c(
      s.reduce(function (e, t, r) {
        return e + (r ? "|" : "") + "(" + n("escapeRegex")(t) + ")";
      }, ""),
    );
    function m(e, t, r, o, a, i, s) {
      (r === void 0 && (r = ""),
        o === void 0 && (o = "."),
        a === void 0 && (a = 0),
        i === void 0 && (i = { primaryGroupSize: l, secondaryGroupSize: l }));
      var u = i.primaryGroupSize || l,
      ...
      if (Math.abs(parseInt(g, 10)).toString().length >= a) {
        var C = "",
          v = "$1" + r + "$2$3",
          S = "(\\d)(\\d{" + (u - 0) + "})($|\\D)";
        if (((C = g.replace(c(S), v)), C != g)) {
          g = C;
          for (
            var R = "(\\d)(\\d{" + (d - 0) + "})(" + n("escapeRegex")(r) + ")",
              L = c(R);
            (C = g.replace(L, v)) != g;
          )
            g = C;
    ...
    function _(t, r) {
      var o = n("NumberFormatConsts").get(
        (e || (e = n("FbtHooks"))).getViewerContext().locale,
      );
      return m(
        t,
        r,
    ...
    function b(e, t) {
      var n = e.indexOf("."),
        r = n === -1 ? e : e.slice(0, n),
        o = n === -1 ? "" : e.slice(n + 1);
      return t != null ? r + "." + C(o.slice(0, t), t - o.length) : r;
    }
    function v(e, t, r) {
      r === void 0 && (r = "");
      var o = R(),
      ...
      (o &&
        ...
        (a = a.replace(/^[^\d]*\-/, "")),
        (a = a.replace(d, "")));
      var i = n("escapeRegex")(t),
        l = n("escapeRegex")(r),
        s = c("^[^\\d]*\\d.*" + i + ".*\\d[^\\d]*$");
      if (!s.test(a)) {
        var u = c("(^[^\\d]*)" + i + "(\\d*[^\\d]*$)");
        if (u.test(a)) return ((a = a.replace(u, "$1$2")), S(a));
        var m = c("^[^\\d]*[\\d " + n("escapeRegex")(l) + "]*[^\\d]*$");
        return (m.test(a) || (a = ""), S(a));
      }
      var p = c("(^[^\\d]*[\\d " + l + "]*)" + i + "(\\d*[^\\d]*$)");
      return ((a = p.test(a) ? a.replace(p, "$1$2") : ""), S(a));
    }
    function S(e) {
      var t = e
          .replace(/[^0-9\u0001\u0002]/g, "")
    ...
    function R() {
      var t = n("NumberFormatConsts").get(
          (e || (e = n("FbtHooks"))).getViewerContext().locale,
        ),
        r = {},
        o = t.numberingSystemData && t.numberingSystemData.digits;
      if (o == null) return null;
      for (var a = 0; a < o.length; a++) r[o.charAt(a)] = a.toString();
      return r;
    }
    function L(t) {
      var r = n("NumberFormatConsts").get(
        (e || (e = n("FbtHooks"))).getViewerContext().locale,
      );
      return v(t, r.decimalSeparator || ".", r.numberDelimiter);
    }
    var E = {
      formatNumber: _,
      formatNumberRaw: m,
      formatNumberWithThousandDelimiters: f,
      formatNumberWithLimitedSigFig: h,
      parseNumber: L,
      parseNumberRaw: v,
      truncateLongNumber: b,
      getFloatString: function (t, n, r) {
        var e = String(t),
          o = e.split("."),
          a = E.getIntegerString(o[0], n);
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e;
    n("FbtEnv").setupOnce();
    var s = n("FbtQTOverrides").overrides,
      u = n("IntlVariationResolver").getGenderVariations,
      c = n("IntlVariationResolver").getNumberVariations,
      d = Object.prototype.hasOwnProperty,
      m = !1,
      p = n("FbtTable").ARG,
      _ = { number: 0, gender: 1 },
      f = { object: 0, possessive: 1, reflexive: 2, subject: 3 },
      g = {};
    function h(t, r, o) {
      if (((o != null && o.hk) || (o != null && o.ehk)) && m)
        return { text: t, fbt: !0, hashKey: o.hk };
      var a = (e || (e = n("FbtHooks"))).getTranslatedInput({
          table: t,
          args: r,
          options: o,
        }),
      ...
      if (c.__vcg != null) {
        i = i || [];
        var p = (e || (e = n("FbtHooks"))).getViewerContext(),
          _ = p.GENDER,
          f = u(_);
        i.unshift(n("FbtTableAccessor").getGenderResult(f, null, _));
      }
      var g = [];
      i &&
        (typeof c != "string" && (c = n("FbtTable").access(c, i, 0, g)),
        (d = y(i)),
        c !== null || l(0, 479));
      var h, b;
      if (Array.isArray(c)) {
        ...
        s[v] != null &&
          s[v] !== "" &&
          ((h = s[v]), (e || (e = n("FbtHooks"))).onTranslationOverride(b));
        var S = { inputTable: t, tokens: g };
        (e || (e = n("FbtHooks"))).logImpression(b, S);
      } else if (typeof c == "string") h = c;
      else
        throw new Error(
      ...
      var R = this.cachedResults[h],
        L = C(d);
      if (R && !L) return R;
      var E = n("substituteTokens")(
          h,
          d,
          (e || (e = n("FbtHooks"))).getErrorListener == null
            ? void 0
            : (e || (e = n("FbtHooks"))).getErrorListener({
                translation: h,
                hash: b,
              }),
        ),
        k = this._wrapContent(E, h, b, o == null ? void 0 : o.eo);
      return (L || (this.cachedResults[h] = k), k);
    }
    function y(e) {
      var t = {};
      return (
        e.forEach(function (e) {
          var n = e[p.SUBSTITUTION];
          if (n)
            for (var r in n)
              d.call(n, r) && (t[r] == null || l(0, 56656, r), (t[r] = n[r]));
        }),
        t
      );
    }
    ...
    function b(e, t) {
      return n("FbtTableAccessor").getEnumResult(e);
    }
    function v(e) {
      return n("FbtTableAccessor").getGenderResult(u(e), null, e);
    }
    function S(e, t, r) {
      var o,
        a = ((o = {}), (o[e] = t), o);
      if (r)
        if (r[0] === _.number) {
          var i = r.length > 1 ? r[1] : t;
          typeof i == "number" || l(0, 484);
          var s = c(i);
          return (
            typeof t == "number" &&
              (a[e] = n("intlNumUtils").formatNumberWithThousandDelimiters(t)),
            n("FbtTableAccessor").getNumberResult(s, a, i)
          );
        } else if (r[0] === _.gender) {
          var d = r[1];
          return (
            d != null || l(0, 485),
            n("FbtTableAccessor").getGenderResult(u(d), a, d)
          );
        } else l(0, 486);
      else return n("FbtTableAccessor").getSubstitution(a);
    }
    function R(e, t, n) {
    ...
    function L(e, t, r) {
      ...
      return (
        t &&
          (typeof r == "number"
            ? (a[t] = n("intlNumUtils").formatNumberWithThousandDelimiters(r))
            : (a[t] =
                r || n("intlNumUtils").formatNumberWithThousandDelimiters(e))),
        n("FbtTableAccessor").getNumberResult(o, a, e)
      );
    }
    function E(e, t, r) {
      t !== n("GenderConst").NOT_A_PERSON || !r || !r.human || l(0, 11835);
      var o = k(e, t);
      return n("FbtTableAccessor").getPronounResult(o);
    }
    function k(e, t) {
      switch (t) {
        case n("GenderConst").NOT_A_PERSON:
          return e === f.object || e === f.reflexive
            ? n("GenderConst").NOT_A_PERSON
            : n("GenderConst").UNKNOWN_PLURAL;
        case n("GenderConst").FEMALE_SINGULAR:
        case n("GenderConst").FEMALE_SINGULAR_GUESS:
          return n("GenderConst").FEMALE_SINGULAR;
        case n("GenderConst").MALE_SINGULAR:
        case n("GenderConst").MALE_SINGULAR_GUESS:
          return n("GenderConst").MALE_SINGULAR;
        case n("GenderConst").MIXED_UNKNOWN:
        case n("GenderConst").FEMALE_PLURAL:
        case n("GenderConst").MALE_PLURAL:
        case n("GenderConst").NEUTER_PLURAL:
        case n("GenderConst").UNKNOWN_PLURAL:
          return n("GenderConst").UNKNOWN_PLURAL;
        case n("GenderConst").NEUTER_SINGULAR:
        case n("GenderConst").UNKNOWN_SINGULAR:
          return e === f.reflexive
            ? n("GenderConst").NOT_A_PERSON
            : n("GenderConst").UNKNOWN_PLURAL;
      }
      return n("GenderConst").NOT_A_PERSON;
    }
    function I(e, t, r) {
      var o = u(r),
        a = {};
      return ((a[e] = t), n("FbtTableAccessor").getGenderResult(o, a, r));
    }
    function T(t, r, o, a) {
    ...
    function $(e) {
      return e instanceof n("FbtResultBase");
    }
    var P = function () {};
    ((P._ = h),
      (P._enum = b),
      ...
      (P._subject = v),
      (P._wrapContent = T),
      (P.disableJsonExportMode = x),
      (P.enableJsonExportMode = D),
      (P.isFbtInstance = $),
      (P.cachedResults = g),
      (P._getCachedFbt = void 0));
    var N = P;
    a.exports = N;
  },
  null,
...
__d(
  ...
  [],
  function (t, n, r, o, a, i) {
    var e = new RegExp("(^|\\.)spark\\.meta\\.com$", "i"),
      l = ["https"];
    function s(t) {
      return (t.isEmpty() && t.toString() !== "#") ||
        (!t.getDomain() && !t.getProtocol())
        ...
        return (
          ...
          (a._invokeErrorHandler = function (t) {
            ...
            if (n) {
              ...
              if (o === C)
                ((i = u._(
                  /*BTDS*/ "Kh\u00f4ng c\u00f3 K\u1ebft n\u1ed1i M\u1ea1ng",
                )),
                  (a = u._(
                    /*BTDS*/ "C\u00f3 v\u1ebb nh\u01b0 tr\u00ecnh duy\u1ec7t c\u1ee7a b\u1ea1n \u0111ang offline. Vui l\u00f2ng ki\u1ec3m tra k\u1ebft n\u1ed1i Internet v\u00e0 th\u1eed l\u1ea1i.",
                  )));
              else if (o >= 300 && o <= 399) {
                ((i = u._(/*BTDS*/ "\u0110\u1ecbnh h\u01b0\u1edbng l\u1ea1i")),
                  (a = u._(
                    /*BTDS*/ "Truy c\u1eadp c\u1ee7a b\u1ea1n v\u00e0o Facebook \u0111\u00e3 b\u1ecb m\u1ed9t b\u00ean th\u1ee9 ba \u0111\u1ecbnh h\u01b0\u1edbng l\u1ea1i ho\u1eb7c ch\u1eb7n t\u1ea1i th\u1eddi \u0111i\u1ec3m n\u00e0y, vui l\u00f2ng li\u00ean h\u1ec7 v\u1edbi Nh\u00e0 cung c\u1ea5p D\u1ecbch v\u1ee5 Internet (ISP) c\u1ee7a b\u1ea1n ho\u1eb7c t\u1ea3i l\u1ea1i.",
                  )));
                ...
                ((i = u._(/*BTDS*/ "R\u1ea5t ti\u1ebfc")),
                  (a = u._(
                    /*BTDS*/ "\u0110\u00e3 x\u1ea3y ra l\u1ed7i. Ch\u00fang t\u00f4i \u0111ang kh\u1eafc ph\u1ee5c s\u1edbm nh\u1ea5t c\u00f3 th\u1ec3. B\u1ea1n c\u00f3 th\u1ec3 th\u1eed l\u1ea1i.",
                  )));
          ...
          (a._unshieldResponseText = function (t) {
            if (t.length <= w) throw new Error("Response too short on async");
            for (var e = 0; t.charAt(e) == " " || t.charAt(e) == "\n"; ) e++;
            return (
              e && t.substring(e, e + w) == M && this.getURI(),
              t.substring(e + w)
            );
          }),
          ...
          (a.setReadOnly = function (t) {
            return (typeof t != "boolean" || (this.readOnly = t), this);
          }),
          ...
          (a.setOption = function (t, n) {
            return (
              typeof this.option[t] != "undefined" && (this.option[t] = n),
              this
            );
          }),
          ...
          (a.send = function (a) {
            ...
            if (
              ...
              if (!T(u)) return (this.uri.toString(), !1);
          ...
          (a._canSendCredentials = function () {
            ...
            var e = new (m || (m = r("URI")))(this.uri);
            return (
              r("isFacebookURI")(e) ||
              r("isInternalFBURI")(e) ||
              r("isMessengerDotComURI")(e) ||
              r("isWorkplaceDotComURI")(e) ||
              r("isWorkroomsDotComURI")(e) ||
              r("isWorkDotMetaDotComURI")(e) ||
              r("isHorizonDotMetaDotComURI")(e) ||
              r("isSparkDotMetaDotComURI")(e) ||
              r("isWearablesDotDeveloperDotMetaDotComURI")(e) ||
              r("isDevelopersDotMetaDotComURI")(e) ||
              r("isArDotMetaDotComURI")(e) ||
              r("isAIDemosDotMetaDotComURI")(e) ||
              r("isBugBountyDotMetaDotComURI")(e)
            );
          }),
        ...
        return (
          ...
          (n._transportErrorHandler = function (t) {
            var e = this,
              ...
              r = this._requests.filter(Boolean).map(function (t) {
                return (
                  e._wrapperRequest && (t.id = e._wrapperRequest.id),
...
__d(
  ...
  [],
  function (t, n, r, o, a, i) {
    var e = new RegExp("(^|\\.)fbaddins\\.com$", "i"),
      l = ["https"];
    function s(t) {
      return (t.isEmpty() && t.toString() !== "#") ||
        (!t.getDomain() && !t.getProtocol())
  ...
  function (t, n, r, o, a, i) {
    ...
    function s(t) {
      return (t.isEmpty() && t.toString() !== "#") ||
        (!t.getDomain() && !t.getProtocol())
        ? !1
        : l.includes(t.getProtocol()) && e.test(t.getDomain());
    }
    i.default = s;
  },
  66,
...
__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    function c(e, t) {
      ((this.data = t || {}),
        (this.uri = e.toString()),
        n("TrackingConfig").domain &&
          this.uri.charAt(0) == "/" &&
          (this.uri = n("TrackingConfig").domain + this.uri));
    }
    ((c.prototype.setHandler = function (e) {
      return ((this.handler = e), this);
    }),
      (c.prototype.setTimeout = function (e) {
        return ((this.timeout = e), this);
      }),
      (c.prototype.send = function () {
        n("TimeSlice").guard(this._send.bind(this), "AsyncSignal send", {
          propagationType: n("TimeSlice").PropagationType.ORPHAN,
        })();
      }),
      (c.prototype._send = function () {
        var t = this.handler,
          r = this.data;
        r.asyncSignal = ((Math.random() * 1e4) | 0) + 1;
        var o = n("ZeroRewrites").rewriteURI(
            new (e || (e = n("URI")))(this.uri),
          ),
          a =
            n("isFacebookURI")(o) ||
            n("isMessengerDotComURI")(o) ||
            n("isAdsExcelAddinURI")(o) ||
            n("isWorkplaceDotComURI")(o) ||
            n("isValidAsyncSignalURI")(o);
        if (a) Object.assign(r, n("getAsyncParams")("POST"));
        else
          throw new Error(
            "'" +
              this.uri +
        ...
        var i = n("QueryString").appendToUrl(this.uri, r),
          c;
        if (
          (u ||
            (u = new (l || (l = n("Promise")))(function (e) {
              n("Run").onAfterLoad(e);
            })),
          (c = u.then(function () {
            return new (l || (l = n("Promise")))(function (e, t) {
              var n = new Image();
              ((n.onload = e), (n.onerror = n.onabort = t), (n.src = i));
            });
          })),
          t)
        ) {
          var d = !1,
            m = n("memoize")(function () {
              (s || (s = n("ErrorGuard"))).applyWithGuard(t, null, [d]);
            });
          (n("promiseDone")(
            c.then(function () {
              ((d = !0), m());
            ...
            this.timeout && setTimeout(m, this.timeout));
        }
        return this;
      }),
      (a.exports = c));
    ...
    var e,
      ...
      f = {
        ...
        getEndPointUrl: function (t) {
          ...
          var n = r("QueryString").appendToUrl(p, e);
          return (n.length <= 2e3 || s(0, 21850, n), n);
        },
        getStorage: function () {
        ...
        subscribe: function (t, n) {
          return m.subscribe(t, n);
        },
        wrapInTimeSlice: function (t, n) {
          return r("TimeSlice").guard(
            function () {
              t();
            },
            n,
        ...
        send: function (n, a, i, l) {
          var t = f.getEndPointUrl(!1),
            s = o("ZeroRewrites").rewriteURI(new (e || (e = r("URI")))(t));
          (u || (u = r("ExecutionEnvironment"))).isInWorker &&
            (s = s.getQualifiedURI());
          var m = o("ZeroRewrites").getTransportBuilderForURI(s)();
          (m.open(_, s.toString(), !0),
            Object.entries(r("getAsyncHeaders")(s)).forEach(function (e) {
              var t = e[0],
                n = e[1];
            ...
            (m.onreadystatechange = function () {
              if (m.readyState >= 4) {
                ...
                t == 200
                  ? (a && a(), l || f.inform((c || (c = r("BanzaiConsts"))).OK))
                  : (i && i(t),
                    l || f.inform((c || (c = r("BanzaiConsts"))).ERROR));
              }
            }),
            d.push(m),
            m.send(n, !1));
      ...
      p = {
        ...
        _flushLazyQueue: function () {
          n("BanzaiLazyQueue")
            .flushQueue()
            .forEach(function (e) {
              return p.post.apply(p, e);
            });
        },
        _gatherWadsAndPostsFromBuffer: function (t, r, o, a, i) {
          var e = {
              currentSize: 0,
              keepRetryable: o,
              overlimit: !1,
              sendMinimumOnePost: i,
              wadMap: new Map(),
            },
            l = a.filter(function (o, a) {
              return n("BanzaiUtils").filterPost(o, t, r, e);
            });
          return (e.overlimit && l.length && p._schedule(0), l);
        },
        _getEventTime: function () {
          return n("cr:9985")();
        },
        _getWebSessionId: function () {
          return n("cr:1172").getId();
        },
        _getPostBuffer: function () {
          return d;
        },
        _getUserId: function () {
          return n("cr:9986").getPossiblyNonFacebookUserID();
        },
        _getAppId: function () {
          return n("cr:9986").getAppID();
        },
        _initialize: function () {
          if ((e || (e = n("ExecutionEnvironment"))).canUseDOM) {
            var t = p.adapter.useBeacon,
              r = p.isEnabled("base_flush_lazy_queue");
            if (
              (r &&
                n("setIntervalAcrossTransitions")(function () {
                  return p._flushLazyQueue();
                }, 3e4),
              t && n("cr:9988").isSupported())
            ) {
              var o;
              ((o = n("cr:9988")).addListener(o.HIDDEN, function () {
                (r && p._flushLazyQueue(),
                  p._getPostBuffer().length > 0 &&
                    (p._tryToSendViaBeacon() || p._store()));
              }),
                o.addListener(o.VISIBLE, function () {
                  (r && p._flushLazyQueue(),
                    p._tryToSendViaBeacon() || p._restore());
                }));
            } else p.adapter.setHooks(p);
            (p.adapter.setUnloadHook(p),
              n("cr:9987").addListener(
                n("cr:9987").Events.NAVIGATION_DONE,
                function (e, t) {
                  t.pageType === "normal" &&
                    (p._restore(), n("cr:9987").removeCurrentListener());
                },
              ),
              r &&
                n("Run").onBeforeUnload(function () {
                  p._flushLazyQueue();
                }));
          }
        },
        _sendBeacon: function (n, r) {
          return t.navigator.sendBeacon(n, r);
        },
        _prepForTransit: function (t) {
          var e = new FormData();
          e.append("ts", String(Date.now()));
          var r = n("BanzaiCompressionUtils").outOfBandsPosts(t);
          return (
        ...
        _prepWadForTransit: function (t) {
          n("BanzaiCompressionUtils").compressWad(
            t,
            n("cr:2037").preferredCompressionMethod(),
          );
        },
        _processCallbacksAndSendViaBeacon: function () {
          var e = [],
            ...
            r = [];
          if (
            (p._gatherWadsAndPostsFromBuffer(t, r, !0, e, !1), t.length > 0)
          ) {
            ((t[0].send_method = "beacon"), t.map(p._prepWadForTransit));
            var o = p._prepForTransit(t),
              a = n("cr:2037").getEndPointUrl(!0),
              i = p._sendBeacon(a, o);
            i || n("FBLogger")("banzai").warn("Error sending beacon");
          }
        },
        _restore: function () {
          var e = n("cr:2037").getStorage(),
            t = function (t) {
              d.push(t);
            };
          ((l || (l = n("ErrorGuard"))).applyWithGuard(e.restore, e, [t]),
            p._schedule(
              n("cr:2037").config.RESTORE_WAIT ||
                (s || (s = n("BanzaiConsts"))).VITAL_WAIT,
            ));
        },
        _schedule: function (t) {
          var e = p._getEventTime() + t;
          return !c || e < c
            ? ((c = e),
              n("cr:3724").clear(u),
              (u = n("cr:3724").start(
                n("cr:2037").wrapInTimeSlice(
                  p._sendWithCallbacks,
                  "Banzai.send",
                ),
                t,
              )),
        ...
        _sendWithCallbacks: function (t, r) {
          if (
            ((c = null),
            p._schedule(p.BASIC.delay),
            !n("cr:2037").readyToSend())
          ) {
            r && r();
            return;
          }
          ...
          ((l || (l = n("ErrorGuard"))).applyWithGuard(e.flush, e, [o]),
            n("cr:2037").inform((s || (s = n("BanzaiConsts"))).SEND));
          var a = [],
            i = [];
          if (
            ((d = p._gatherWadsAndPostsFromBuffer(a, i, !0, d, !0)),
            a.length <= 0)
          ) {
            (n("cr:2037").inform((s || (s = n("BanzaiConsts"))).OK), t && t());
            return;
          }
          ((a[0].trigger = m),
            (m = null),
            (a[0].send_method = "ajax"),
            a.map(p._prepWadForTransit),
            n("cr:2037").send(
              p._prepForTransit(a),
              function () {
                (i.forEach(function (e) {
                  var t = e;
                  ((t.__meta.status = (s || (s = n("BanzaiConsts"))).POST_SENT),
        ...
        _store: function () {
          var e = n("cr:2037").getStorage();
          (l || (l = n("ErrorGuard"))).applyWithGuard(e.store, e, [d]);
        },
        _testState: function () {
          return { postBuffer: d, triggerRoute: m };
        },
        _tryToSendViaBeacon: function () {
          ...
          var e = [],
            t = [];
          if (
            ((d = p._gatherWadsAndPostsFromBuffer(e, t, !1, d, !1)),
            e.length <= 0)
          )
            return !1;
          ((e[0].send_method = "beacon"), e.map(p._prepWadForTransit));
          var r = p._prepForTransit(e),
            o = n("cr:2037").getEndPointUrl(!0),
            a = p._sendBeacon(o, r);
          return a
            ? !0
        ...
        _unload: function () {
          n("cr:2037").config.disabled ||
            (p._flushLazyQueue(),
            navigator &&
              navigator.sendBeacon &&
              n("cr:2037").isOkToSendViaBeacon() &&
              p._processCallbacksAndSendViaBeacon(),
            n("cr:2037").cleanup(),
            n("cr:2037").inform((s || (s = n("BanzaiConsts"))).SHUTDOWN),
            d.length > 0 &&
              (!p.adapter.useBeacon || !p._tryToSendViaBeacon()) &&
              p._store());
        },
        BASIC: {
          delay:
            n("cr:2037").config.MAX_WAIT ||
            (s || (s = n("BanzaiConsts"))).BASIC_WAIT,
        },
        BASIC_WAIT: (s || (s = n("BanzaiConsts"))).BASIC_WAIT,
        ERROR: s.ERROR,
        OK: s.OK,
        SEND: s.SEND,
        SHUTDOWN: s.SHUTDOWN,
        VITAL: {
          delay:
            n("cr:2037").config.MIN_WAIT ||
            (s || (s = n("BanzaiConsts"))).VITAL_WAIT,
        },
        VITAL_WAIT: s.VITAL_WAIT,
        adapter: n("cr:2037"),
        ...
        flush: function (t, r) {
          (n("cr:3724").clear(u), p._sendWithCallbacks(t, r));
        },
        isEnabled: function (t) {
          return !!(
            n("cr:2037").config.gks &&
            n("cr:2037").config.gks[t] &&
            !n("cr:2037").config.disabled
          );
        },
        post: function (r, o, a) {
          ...
          if (
            !(
              (n("cr:2037").config.known_routes || []).indexOf(t[0]) === -1 &&
              (n("cr:2037").config.should_log_unknown_routes === !0 &&
                n("FBLogger")("banzai")
                  .blameToPreviousFrame()
                  .mustfix(
              ...
              n("cr:2037").config.should_drop_unknown_routes === !0)
            )
          ) {
            var i = "";
            try {
              var l;
              i = (l = JSON.stringify(o)) != null ? l : "";
            } catch (e) {
              var u = n("getErrorSafe")(e);
              n("FBLogger")("banzai")
                .catching(u)
                .addToCategoryKey(r)
                .mustfix(
                  "Could not JSON.stringify banzai data for route %s",
                  r,
                );
              return;
            }
            var c = a == null ? void 0 : a.retry;
            if (
              !n("cr:2037").config.disabled &&
              !(
                !(e || (e = n("ExecutionEnvironment"))).canUseDOM &&
                !(e || (e = n("ExecutionEnvironment"))).isInWorker
              )
            ) {
              var _ = n("cr:2037").config.blacklist;
              if (
                !(
                  _ &&
                  _.indexOf &&
                  typeof _.indexOf == "function" &&
                  _.indexOf(r) != -1
                )
              ) {
                var f = i.length,
                  g = n("BanzaiUtils").wrapData(r, o, p._getEventTime(), c, f),
                  h = g;
                (a != null &&
                  a.callback &&
                  (h.__meta.callback = a == null ? void 0 : a.callback),
                  (a == null ? void 0 : a.compress) != null &&
                    (h.__meta.compress = a == null ? void 0 : a.compress));
                var y = a == null ? void 0 : a.delay;
                if (
                  (y == null && (y = (s || (s = n("BanzaiConsts"))).BASIC_WAIT),
                  a != null && a.signal)
                ) {
                  h.__meta.status = (
                    s || (s = n("BanzaiConsts"))
                  ...
                  var C = [
                    {
                      user: p._getUserId(),
                      webSessionId: p._getWebSessionId(),
                      app_id: p._getAppId(),
                      posts: [g],
                      trigger: r,
                    },
                    ...
                    (n("cr:2037").send(
                      ...
                      function () {
                        ((h.__meta.status = (
                          ...
                          h.__meta.callback && h.__meta.callback());
                      },
                      function (e) {
                        n("BanzaiUtils").retryPost(g, e, d);
                      },
                      !0,
                    ),
                    !c)
                ...
                (d.push(g), (p._schedule(y) || !m) && (m = r));
              }
            }
          }
        },
        subscribe: n("cr:2037").subscribe,
      };
    p._initialize();
    var _ = p;
    i.default = _;
...
__d(
  ...
  ["$InternalEnum"],
  function (t, n, r, o, a, i) {
    var e = n("$InternalEnum")({ FACEBOOK: 1, INSTAGRAM: 2, OCULUS: 3 }),
      l = e;
    i.default = l;
  },
  66,
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    "use strict";
    var e = n("cr:1094907") == null ? void 0 : n("cr:1094907").logImpression,
      s = n("cr:8828") == null ? void 0 : n("cr:8828").logImpressionV2;
    ((l.logImpression = e), (l.logImpressionV2 = s));
  },
  98,
);
__d(
...
__d(
  ...
  function (t, n, r, o, a, i, l, s) {
        ...
        r != null &&
          ...
          (t === "TRANSLATION"
            ...
            : t === "APPROVE"
              ...
              : t === "REPORT" && (a = "_4qbd")),
        {
          $$typeof: o("FbtReactUtil").REACT_ELEMENT_TYPE,
          type: "em",
          key: null,
          ref: null,
          props: {
    ...
    var c = function (t) {
        return u(t.content, t.inlineMode, t.translation, t.hash);
      },
      d = (function (t) {
        function n(n, a, i, l) {
          var s;
          return (
            ...
            (s.ref = null),
            (s.type = c),
            (s.props = { content: n, inlineMode: a, translation: i, hash: l }),
            s
          );
        }
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    "use strict";
    var e = r("getFalcoLogPolicy_DO_NOT_USE")("1848815"),
      s = o("FalcoLoggerInternal").create("intl_qt_event", e),
      u = s;
    l.default = u;
  },
  98,
...
__d(
  ...
  [],
  function (t, n, r, o, a, i) {
    var e = Object.freeze({ cookieName: "dpr" });
    i.default = e;
  },
  66,
);
      ...
      s = (function () {
        ...
        function t(t, r, o) {
          ...
          ((e = this),
            ...
            (this.$2 = r),
            (this.$3 = !1),
            n("DOMEventListener").add(this.$1, "submit", function (e) {
              if (a.$3) {
                new (n("DOMEvent"))(e).kill();
                return;
              }
              ((a.$3 = !0), o && n("CSS").addClass(t, "_32qa"));
            }));
        }
        ...
        return (
          ...
          (r.hasBeenSubmitted = function () {
            return this.$3;
          }),
          t
        );
      })();
    ((s.RESPONSE = "platform/dialog/response"), (a.exports = s));
  },
  null,
);
__d(
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e = new (n("StrSet"))(
        n("getObjectValues")(n("PlatformVersions").versions),
      ),
      s = location.pathname,
      u = s.substring(1, s.indexOf("/", 1)),
      c = e.contains(u) ? u : n("PlatformVersions").versions.UNVERSIONED;
    function d(t, r) {
      if (r == n("PlatformVersions").versions.UNVERSIONED) return t;
      e.contains(r) || l(0, 3769);
      var o = t.indexOf("/") !== 0 ? "/" + t : t;
      return "/" + r + o;
    }
    function m() {
      return n("PlatformVersions").LATEST;
    }
    function p() {
      return n("PlatformVersions").LATEST_LAUNCHED;
    }
    function _(e) {
      return e.setPath(d(e.getPath(), c));
    }
    function f(e) {
      return d(e, c);
    }
    function g(t) {
      return e.contains(t.substring(1, t.indexOf("/", 1)))
    ...
    var h = {
        addVersionToPath: d,
        getLatestVersion: m,
        getLatestLaunchedVersion: p,
        versionAwareURI: _,
        versionAwarePath: f,
        getUnversionedPath: g,
      },
      y = h;
    i.default = y;
  },
...
__d(
  ...
  function (t, n, r, o, a, i) {
    function e(e, t) {
      return n("PlatformVersioning").versionAwarePath(
        "/dialog/" + e + (t ? "/" + t : ""),
      );
    }
    function l(e, t) {
    ...
    function s(e) {
      return /^\/plugins\//.test(n("PlatformVersioning").getUnversionedPath(e));
    }
    function u(e) {
      return /^\/dialog\//.test(n("PlatformVersioning").getUnversionedPath(e));
    }
    var c = { dialog: e, plugins: l, isPluginEndpoint: s, isDialogEndpoint: u };
    a.exports = c;
  },
  null,
);
__d(
  ...
  function (t, n, r, o, a, i) {
    var e = {
      ...
      connect: function (r, o) {
        var t = { identifier: r, href: r, story_fbid: o };
        (n("Arbiter").inform(e.CONNECT, t),
          n("ArbiterFrame").inform(e.CONNECT, t));
      },
      disconnect: function (r, o) {
        var t = { identifier: r, href: r, story_fbid: o };
        (n("Arbiter").inform(e.DISCONNECT, t),
          n("ArbiterFrame").inform(e.DISCONNECT, t));
      },
      error: function (r, o) {
        n("Arbiter").inform(e.ERROR, { action: r, content: o });
      },
      reload: function (r) {
        (n("Arbiter").inform(e.RELOAD, { reloadUrl: r || "" }),
          n("ArbiterFrame").inform(e.RELOAD, { reloadUrl: r || "" }));
      },
      reloadOtherPlugins: function (r, o) {
        n("ArbiterFrame").inform(e.RELOAD, {
          reloadUrl: "",
          reload: r || "",
          identifier: o || "",
        });
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    function e() {
      var e = document.getElementById("jsbundle-loader");
      e && r("DOM").remove(e);
    }
    l.init = e;
  },
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e =
        !r("UserAgent").isBrowser("Safari < 12") &&
    ...
    !s &&
      ...
      r("promiseDone")(
        ...
        function (e) {
          (o("Log").debug("hasStorageAccess=%s", e), (s = e));
        },
        function (e) {
          return o("Log").warn("Storage access check failed: %s", e);
        },
      );
    function c(t, n, a, i) {
      if ((i === void 0 && (i = !1), !e || s || u))
        return o("DOMEventListener").add.apply(this, arguments);
      var l = function () {
        for (
          ...
          n[i] = arguments[i];
        if (s || u) return a.apply(this, n);
        var l = document.requestStorageAccess().then(
          function (t) {
            return (
              o("Log").debug("Storage access request granted."),
              (s = !0),
              a.apply(e, n)
            );
          },
          function (t) {
            return (
              o("Log").warn("Storage access request denied."),
              (u = !0),
              a.apply(e, n)
            );
          },
      ...
      return o("DOMEventListener").add.call(null, t, n, l, i);
    }
    ((l.add = c), (l.remove = o("DOMEventListener").remove));
  },
  98,
);
__d(
  ...
  function (t, n, r, o, a, i, l) {
    function e() {
      "hasStorageAccess" in document &&
        r("promiseDone")(document.hasStorageAccess(), function (e) {
          document.body &&
            !e &&
            o("PluginDOMEventListener").add(
              document.body,
              "click",
              function () {
                location.reload();
    ...
    var e = (function () {
      function e(e, t, n, o) {
        ...
        (e.removeAttribute("id"),
          o === null || n !== null || u(0, 2812),
          (this.$1 = e),
          (this.$2 = n),
          (this.$3 = o),
          t === !1 &&
            (r("Event").listen(e, "click", function () {
              return a.toggleButton();
            }),
            r("Event").listen(e, "toggle", function () {
              return a.toggleButton();
            })));
      }
      var t = e.prototype;
      return (
        (t.toggleButton = function () {
          var e = this;
          o("CSS").hasClass(this.$1, "active") === !1
            ? (o("CSS").addClass(this.$1, "active"),
              this.$4(!0),
              o("CSS").addClass(this.$1, "is_animating"),
              setTimeout(function () {
                o("CSS").removeClass(e.$1, "is_animating");
              }, 240))
            : (o("CSS").removeClass(this.$1, "active"), this.$4(!1));
        }),
        (t.setTitle = function (t) {
          this.$1.setAttribute("title", t);
        }),
        (t.$4 = function (t) {
          var e = function (t) {
            return s._(/*BTDS*/ "{count}", [
              s._param("count", r("intlSummarizeNumber")(t, 0)),
            ]);
          };
          this.$3 != null &&
            this.$3 < 1e3 &&
            ((this.$3 = t ? this.$3 + 1 : this.$3 - 1),
            r("DOM").setContent(this.$2, e(this.$3)));
        }),
        (t.isActivated = function () {
          return o("CSS").hasClass(this.$1, "active");
        }),
        e
      );
    })();
  ...
  function (t, n, r, o, a, i, l) {
    var e,
      ...
      u = {
        ...
        init: function (t) {
          var e = this;
          ((this._opts = babelHelpers.extends({}, this._opts, t)),
            this._opts.autoResize && this._startResizeMonitor(),
            r("Arbiter").subscribe(
              "Connect.Unsafe.resize.ack",
              function (t, n) {
                (n.id || (n.id = e._resizeCount),
                  n.id > e._lastResizeAckId && (e._lastResizeAckId = n.id));
              },
            ));
        },
        getQueue: function () {
          return (
            this._queue || (this._queue = new (r("Queue"))()),
            this._queue
          );
        },
        setChannelUrl: function (t) {
          var e = this;
          this.getQueue().start(function (n) {
            return e.send(n, t);
          });
        },
        send: function (n, a) {
          ...
          Object.assign(
            t,
            n,
            (e || (e = o("PHPQuerySerializer"))).deserialize(i.getFragment()),
          );
          var l = new s(t.origin);
          if (l.getDomain() === "") {
            o("Log").error("No valid domain for XD message target.");
            return;
          }
          var u = l.getOrigin();
          ...
          var c = r("resolveWindow")(t.relation.replace(/^parent\./, "")),
            d = 1,
            m = function () {
              try {
                c.postMessage(
                  (e || (e = o("PHPQuerySerializer"))).serialize(t),
                  u,
                );
              } catch (e) {
                var a = r("getErrorSafe")(e);
                --d
                  ? window.setTimeout(m, 200)
                  : o("sdk.Scribe").log("jssdk_error", {
                      error: "POST_MESSAGE",
                      extra: {
                        message: a.message + ", html/js/modules/XD.js:139",
        ...
        _computeSize: function () {
          var e = o("DOMDimensions").getDocumentDimensions(),
            t = 0;
          if (this._opts.resizeWidth) {
            var n = document.body;
            if (n != null) {
              if (n.clientWidth < n.scrollWidth) t = e.width;
              else {
                var a = n.lastElementChild;
                if (a != null && a instanceof HTMLElement) {
                  var i = a,
                    l = i.offsetLeft + i.offsetWidth;
                  l > t && (t = l);
                }
              }
              t = Math.max(t, u._forcedMinWidth);
            } else t = u._forcedMinWidth;
          }
          return (
            (e.width = t),
            this._opts.allowShrink &&
              (this._shrinker || (this._shrinker = r("DOM").create("div")),
              r("DOM").appendContent(document.body, this._shrinker),
              (e.height = Math.max(this._shrinker.offsetTop, 0))),
            e
          );
        },
        _startResizeMonitor: function () {
          var e,
            t = this,
            n,
            o = (e = document.documentElement) != null ? e : {};
          if (this._opts.hideOverflow) {
            var a;
            ((o.style.overflow = "hidden"),
              (((a = document.body) != null ? a : {}).style.overflow =
                "hidden"));
          }
          var i = function () {
            var e = t._computeSize(),
              o = Date.now();
            if (
              !n ||
              (t._opts.allowShrink && n.width != e.width) ||
              (!t._opts.allowShrink && n.width < e.width) ||
              (t._opts.allowShrink && n.height != e.height) ||
              (!t._opts.allowShrink && n.height < e.height)
            ) {
              ((n = e), t._resizeCount++, (t._resizeTimestamp = o));
              var a = {
                type: "resize",
                height: e.height,
                ackData: { id: t._resizeCount },
                width: 0,
              };
              e.width && e.width != 0 && (a.width = e.width);
              try {
                if (
                  r("isFacebookURI")(
                    new (s || (s = r("URI")))(document.referrer),
                  ) &&
                  r("isInIframe")() &&
                  window.name &&
                  ...
                  r("isFacebookURI")(
                    new (s || (s = r("URI")))(window.parent.location),
                  )
                )
                  for (
                    var i =
                    ...
                    i[l].name == window.name &&
                      (t._opts.resizeWidth &&
                        (i[l].style.width = a.width + "px"),
                      (i[l].style.height = a.height + "px"));
                t.send(a);
              } catch (e) {
                t.send(a);
              }
          ...
          (i(), window.setInterval(i, this._opts.resizeTimeout));
        },
      },
      c = babelHelpers.extends({}, u);
    ((t.UnverifiedXD = c), (t.XD = u), (l.XD = u), (l.UnverifiedXD = c));
  },
  98,
);
__d(
...
__d(
  ...
  function (t, n, r, o, a, i) {
    function e(t) {
      var r = t.parentNode;
      return !r || r === document.documentElement
        ? document.documentElement
        : n("Style").get(r, "position") !== "static"
          ? r
          : r === document.body
            ? document.documentElement
            : e(r);
...
__d(
  ...
  function (t, n, r, o, a, i) {
    function e(e) {
      e = e || document.body;
      var t = 0,
        r = n("getOffsetParent")(e);
      return (
        n("Locale").isRTL() && r
          ? (t = r.offsetWidth - e.offsetLeft - e.offsetWidth)
          : n("Locale").isRTL() || (t = e.offsetLeft),
        l(e) + t
      );
    }
    function l(e) {
      return (
        Math.ceil(parseFloat(n("getStyleProperty")(e, "width"))) ||
        e.offsetWidth
      );
    }
    function s(e) {
      return ((e = e || document.body), e.offsetHeight + e.offsetTop);
    }
    function u(t, n, r) {
      ((this.calcWidth = t || e),
        (this.calcHeight = n || s),
      ...
      resize: function () {
        ...
        return (
          (e !== this.width || t !== this.height) &&
            ...
            (this.width = e),
            (this.height = t),
            n("UnverifiedXD").send({ type: this.event, width: e, height: t })),
          this
        );
      },
      auto: function (t) {
        return (setInterval(this.resize.bind(this), t || 250), this);
      },
    }),
      (u.auto = function (t, n, r) {
        return new u(e.bind(null, t), s.bind(null, t), n).resize().auto(r);
      }),
      (u.autoHeight = function (e, t, n, r) {
        return new u(
          function () {
            return e;
          },
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e;
    n("Arbiter").subscribe(n("PlatformDialog").RESPONSE, function (e, t) {
      if (t.error_code) {
        n("Log").debug(
      ...
      n("Plugin").reload(t.plugin_reload);
    });
    var s = {
      auto: function () {
        n("Arbiter").subscribe(n("Plugin").RELOAD, function (e, t) {
          var n = typeof t == "object" ? t.reloadUrl : t;
          s.reload(n);
        });
      },
      syncPlugins: function () {
        n("Arbiter").subscribe(n("Plugin").RELOAD, function (e, t) {
          t.crossFrame && s.reload(t.reloadUrl, t.reload, t.identifier);
        });
      },
      reload: function (r, o, a) {
        var t = (e || (e = n("URI")))
          .getRequestURI()
          .removeQueryData("ret")
          .removeQueryData("act")
          .removeQueryData("hash")
          .addQueryData("reload", o)
          .addQueryData("id", a);
        if (r) {
          var o = new (e || (e = n("URI")))(r);
          (n("PlatformWidgetEndpoint").isPluginEndpoint(o.getPath()) ||
            l(0, 1120),
            t.setPath(o.getPath()).addQueryData(o.getQueryData()));
        }
...
__d(
  ...
  ["XController"],
  function (t, n, r, o, a, i) {
    a.exports = n("XController").create("/dcb/tcnle/", {
      t: { type: "String" },
    });
  },
  null,
...
__d(
  "PluginShareActions",
  ["AsyncRequest", "Event", "ThisControllerNoLongerExists"],
  function (t, n, r, o, a, i, l) {
    "use strict";
    function e(e, t, n, a, i, l, s) {
      r("Event").listen(i, "click", function (i) {
        new (r("AsyncRequest"))()
          .setURI(
            o("ThisControllerNoLongerExists")
              .__DEADBUILDER__("g584vh1q")
              .getURI(),
          )
          .setData({
            app_id: l,
    ...
    (window.addEventListener(
      ...
      function (e) {
        if (
          ...
          o("SecurePostMessage").sendMessageAllowAnyOrigin_UNSAFE(e.source, {
            xdArbiterAck: !0,
          });
        else if (e.data.xdArbiterHandleMessage) {
          if (!e.data.message.method) return;
          try {
            r("Arbiter").inform(
              "Connect.Unsafe." + e.data.message.method,
              JSON.parse(e.data.message.params),
              "persistent",
            );
          } catch (e) {}
        }
      ...
      (t.XdArbiter = e),
      r("UnverifiedXD").send({ xd_action: "plugin_ready", name: window.name }));
    var s = null;
    l.default = s;
  },
  98,
...
__d(
  ...
  function (t, n, r, o, a, i) {
    var e = {
      listen: function (t, r, o) {
        n("DOMEventListener").add(t, "click", function (e) {
          (new (n("DOMEvent"))(e).kill(), n("Popup").open(t.href, r, o));
        });
      },
    };
    a.exports = e;
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function c() {
      r("Cookie").set(r("PixelRatioConst").cookieName, String(u()));
    }
    function d() {
      s || ((s = !0), u() !== o("WebPixelRatio").get() && c());
    }
    function m(t) {
      e ||
        ((e = !0),
        "onpagehide" in window &&
          o("DOMEventListener").add(window, "pagehide", d),
        o("Run").onBeforeUnload(d, !1));
    }
    l.startDetecting = m;
  },
  98,
...
__d(
  ...
  function (t, n, r, o, a, i) {
    function e(e) {
      var t = e.contents,
        r = n("FbtResultGK").inlineMode,
        o = n("FbtResultGK").shouldReturnFbtResult;
      if (!o && r !== "REPORT")
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function e(e) {
      ...
      return r("FbtResultGK").inlineMode != null &&
        ...
        ? new (r("InlineFbtResult"))(n, r("FbtResultGK").inlineMode, o, a)
        : r("FbtResult").get(e);
    }
    l.default = e;
  },
