...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    function e(e) {
      return (e.id || (e.id = r("uniqueID")()), e.id);
    }
    l.default = e;
  },
  98,
              ...
              remove: function () {
                for (var e in m) {
                  if (c.handlers[e] && c.handlers[e].length) {
                    var t = c.handlers[e].indexOf(m[e]);
      ...
      p = (function (e) {
        ...
        return (
          ...
          (n._configure = function (t, n) {
            ...
            if (n) {
              var a = r("isNode")(n),
                i = typeof n == "string" || r("HTML").isHTML(n);
              if (
                ...
                n = r("HTML")(n).getRootNode();
              else if (this.containsReactComponent) {
                var l = document.createElement("div");
                (g(n, l, function () {
                  (e.inform("reactshow"), e.updatePosition());
                }),
                  (n = this._reactContainer = l));
              }
            }
            ((this._root = this._buildWrapper(t, n)),
              ...
              t.permanent && (this._permanent = t.permanent),
              t.isStrictlyControlled &&
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    function e(e) {
      setTimeout(function () {
        var t = "border-bottom-width",
          n = r("Style").get(e, t);
        (r("Style").set(e, t, parseInt(n, 10) + 1 + "px"),
          r("Style").set(e, t, n));
      }, 1e3);
    }
    l.trigger = e;
...
__d(
  "PluginMessage",
  ["Arbiter", "CSS", "DOM", "DOMEventListener"],
  function (t, n, r, o, a, i, l) {
    var e = "platform/plugins/checkbox_connect/access_token";
    function s() {
      o("DOMEventListener").add(window, "message", function (e) {
        if (/\.facebook\.com$/.test(e.origin) && u().test(e.data)) {
          var t = JSON.parse(e.data.substring(24));
          "type" in t &&
            (t.type === "messenger_checkbox"
              ? c(t)
              : t.type === "customer_chat" && m(t));
        }
      });
    }
    function u() {
    ...
    function c(t) {
      var n = document.getElementById("plugin-MN-commerce-identity"),
        a = document.getElementById(
          "plugin-MN-commerce-identity-profile-picture",
        ),
        i = document.getElementById("plugin-MN-commerce-identity-profile-name"),
        l = document.getElementById("web-plugin-checkbox-form");
      n != null &&
        a != null &&
        i != null &&
        l != null &&
        (t.can_personalize === !0
          ? (d(a, t.profile_photo),
            ...
            o("CSS").show(n),
            d(l, t.checkbox),
            t.access_token != null && r("Arbiter").inform(e, t.access_token))
          : o("CSS").hide(n));
    }
    function d(e, t) {
      var n = document.createElement("div");
      r("DOM").setContent(n, t);
      var o = n.firstChild;
      o != null && e.replaceWith(o);
    }
    function m(e) {
      var t = window.require("Arbiter");
      "ArbiterData" in e
        ? t.inform(e.ArbiterEvent, e.ArbiterData)
        : t.inform(e.ArbiterEvent);
    }
    ((l.MESSENGER_CHECKBOX_ACCESS_TOKEN_LOGIN_ARBITER = e), (l.listen = s));
  },
  98,
);
__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    function l(t) {
      (Object.assign(this, {
        plugin: t,
        confirm_params: {},
        return_params: (e || (e = n("URI"))).getRequestURI().getQueryData(),
      }),
        this.addReturnParams({ ret: "sentry" }),
        delete this.return_params.hash);
    }
    (Object.assign(l.prototype, {
      addConfirmParams: function (t) {
        Object.assign(this.confirm_params, t);
      },
      addReturnParams: function (t) {
        return (Object.assign(this.return_params, t), this);
      },
      start: function () {
        var t = n("PlatformVersioning")
          .versionAwareURI(
            new (e || (e = n("URI")))("/plugins/error/confirm/" + this.plugin),
          )
        ...
        return (
          (this.popup = n("PopupWindow").open(t.toString(), 320, 486)),
          n("PluginMessage").listen(),
          this
        );
      },
    }),
      (l.starter = function (e, t, n) {
        var r = new l(e);
        return (
          r.addConfirmParams(t || {}),
          r.addReturnParams(n || {}),
          r.start.bind(r)
        );
      }),
      (l.listen = function (e, t, r, o) {
        n("DOMEventListener").add(e, "click", function (e) {
          (new (n("DOMEvent"))(e).kill(), l.starter(t, r, o)());
        });
      }),
      (a.exports = l));
  },
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e;
    function s(t, n, a, i, l, s, u, c, d, m) {
      function p(l, s) {
        var u = o("DOMQuery").scry(i, "." + l)[0];
        u &&
          o("DOMEventListener").add(u, "click", function (i) {
            ((e || (e = o("ODS"))).bumpEntityKey(
              2966,
              "platform_www",
              "platform.plugin.page.action",
            ),
              r("BanzaiLogger").log("PagePluginActionsLoggerConfig", {
                page_id: n,
                page_plugin_action: s,
...
__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e,
      ...
      c =
        (e =
          (s =
            (u || (u = r("Env"))) == null
              ? void 0
              : (u || (u = r("Env"))).react_scheduler_enable_paint) != null
            ? s
            : (u || (u = r("Env"))) == null
              ? void 0
              : (u || (u = r("Env"))).react_scheduler_enable_paint_ig) != null
          ? e
          : !1,
      d = !0,
      m = 250,
      p = 5e3,
      _ = 1e4;
    ((l.enableRequestPaint = c),
      (l.enableSchedulerDebugging = d),
      (l.userBlockingPriorityTimeout = m),
      (l.normalPriorityTimeout = p),
      (l.lowPriorityTimeout = _));
  },
  98,
);
__d(
