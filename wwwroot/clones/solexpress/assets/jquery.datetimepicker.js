var datetimepickerFactory = function (L) {
  ...
  function a() {
    ...
    "function" == typeof DateFormatter &&
      (E = o = new DateFormatter({ dateSettings: L.extend({}, r, t) }));
  }
  var s = {
      i18n: {
        ar: {
                ...
                .on("scroll_element.xdsoft_scroller", function (e, t) {
                  (i || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]),
                    ...
                    setTimeout(function () {
                      n.css(
                        "marginTop",
                        -parseInt((n[0].offsetHeight - i) * t, 10),
                      );
                    }, 10));
                })
          ...
          (F.find(".xdsoft_select")
            ...
            _.on("xchange.xdsoft", function (e) {
              (clearTimeout(t),
                (t = setTimeout(function () {
                  ...
                  for (
                    P.html(v), j = "", c = parseInt(I.yearStart, 10);
            ...
            (r = function () {
              ...
              ("rtl" === s.parent().css("direction") &&
                ...
                ((l = { position: r, left: o, top: "", bottom: "" })[u] = a),
                _.css(l));
            }),
