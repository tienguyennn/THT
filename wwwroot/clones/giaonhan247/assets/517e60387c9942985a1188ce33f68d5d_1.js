  ...
  try {
    ...
    var l,
      ...
      T = new Uint8Array([
        ...
        211, 46, 237, 237, 178, 52, 219, 183, 71, 58, 12, 143, 196, 204, 225,
        111, 60, 140, 132, 223, 171, 182, 102, 62, 242, 12, 212, 139, 254, 227,
        249, 118, 47, 20, 28, 99, 8, 106, 111, 45, 177, 26, 149, 176, 206, 55,
        192, 156, 110,
      ]),
...
oSpP = !1;
var oSpPOptions = {
  sAppUrl: "https://giaonhan247.com",
  sAppUrlShow: "https://giaonhan247.com",
  sOrigUrl: "https://giaonhan247.com",
  sOrigFFUrl: "https://giaonhan247.com",
  sSubscribeUrl: "https://.spulse.net",
  sSubscribeFFUrl: "https://.spulse.net",
  ...
  bAutoSubscribe: true,
  sAppKey: "517e60387c9942985a1188ce33f68d5d",
  prompt_settings: "",
  prompt_title: "",
  prompt_text: "",
  prompt_description: "-",
  prompt_settings_whithout_sw:
    '{"title":"","text":"Allow giaonhan247.com to send web push notifications to your desktop.","style":"sp-popover","textcolor":"#222222","backgroundcolor":"#ffffff","buttoncolor":"#31b58e","iconcolor":"","btncolor":"","allowbtntext":"Allow","disallowbtntext":"Don\'t allow","btn_lang":"en","visit_number":1,"icon":"\/files\/push\/7506729\/websites\/517e60387c9942985a1188ce33f68d5d\/icons\/1d9ba269b28f.png"}',
  currentDB: null,
  timeSend: null,
  newWindow: null,
  parentEvent: null,
  ...
  show_splogo: "0",
  spdomain_website:
    "https://sendpulse.com/webpush-powered-by-sendpulse?sn=R2lhb25oYW4yNDc%3D",
  styles_prefix: "sp",
  aPoweredbyLabel: {
...
function oPromptPush() {
  var e = oSpPOptions.sAppUrl,
    ...
    C = oSpPOptions.initedPage,
    T = oSpPOptions.parentVariables,
    A = oSpPOptions.pushedVariables,
    O = oSpPOptions.pushedInterval,
    L = oSpPOptions.sFirefoxServer,
    N = oSpPOptions.sFirefoxServer2,
    x = oSpPOptions.bWasPrompt,
    ...
    q = new Date(),
    X = new Date(q.getFullYear(), q.getMonth() + 1, q.getDate()).getTime();
  X = q.getDate() + "" + X;
  ...
  ((this.start = function () {
    ...
    if (((u = oSpP.detectOs()), !H && ("iOS" == u || "Android" == u)))
    ...
    if (n && J)
      if (P)
        ...
        for (
          var r = document.querySelectorAll("." + Y + "_notify_prompt"), a = 0;
          a < r.length;
          a++
        )
      ...
      for (
        r = document.querySelectorAll("." + Y + "_notify_prompt"), a = 0;
        a < r.length;
        a++
      )
        r[a].addEventListener("click", function () {
          ...
          if (oSpP.detectOrigin(e.origin) && "string" == typeof e.data)
            if ("init" == e.data)
              ...
              2 == (t = e.data.split("|")).length &&
                ((C = t[1]),
                localStorage.setItem("source_url", C),
                !0,
                oSpP.startSubscription(),
            ...
            (navigator.serviceWorker.getRegistrations().then(function (e) {
              if (e)
                for (var t = 0; t < e.length; t++)
                  e[t].active &&
                    -1 !=
                      e[t].active.scriptURL.indexOf(Y + "-push-worker.js") &&
                    e[t].unregister();
            }),
              oSpP.isServiceWorkerChromeSupported() &&
    ...
    (this.isYandexBrowser = function () {
      return (
        "YaBrowser" ===
        (navigator.userAgent.match(/(YaBrowser(?=\/))\/?\s*(\d+)/i) || [])[1]
      );
    }),
    (this.isMobileYandexBrowser = function () {
      return !(
        !oSpP.isYandexBrowser() ||
    ...
    (this.registerChrome = function () {
      navigator.serviceWorker
        .register("/" + Y + "-push-worker-fb.js", { updateViaCache: "none" })
        .then(function (e) {
          e.installing
        ...
        "default" === e.permission
          ...
          : "denied" === e.permission
            ? (P ? oSpP.closePromptHelpText(!0) : oSpP.closeCustomPrompt(!0),
              x && oSpP.sendPromptStat("prompt_denied"),
              oSpP.sendToParent("closeme"))
            : "granted" === e.permission &&
              (oSpP.uns(),
              P ? oSpP.closePromptHelpText(!0) : oSpP.closeCustomPrompt(!0),
              x && oSpP.sendPromptStat("prompt_granted"),
              oSpP.subscribe()),
        oSpP.closePushLabel());
    }),
    ...
    (this.getUserVariables = function () {
      for (
        var e = {},
          t = document.querySelectorAll("input." + Y + "_push_custom_data"),
          o = 0;
        o < t.length;
        o++
      )
    ...
    (this.sendSubscribeDataToServer = function (e, t, o, i, s) {
      ...
      (p &&
        ...
        void 0 === o &&
          ...
          (o.os = oSpP.detectOs())),
        void 0 === i && (i = ""),
        (o.variables = p && !J ? T : oSpP.getUserVariables()));
      var a,
        u = -new Date().getTimezoneOffset() / 60;
      if (((o.timezoneoffset = u), C)) a = C;
      else {
      ...
      (oSpP.initCustomSubmitEvent(), n.send(JSON.stringify(P)));
    }),
    ...
    (this.showPopUp = function () {
      ...
      ("" == a && (a = "en"),
        (I = window.open(
          s + "/" + a + "/" + g + "/" + r,
          "_blank",
          "scrollbars=yes, width=580, height=580, top=" + p + ", left=" + n,
        )),
    ...
    (this.closePrompt = function (e) {
      (void 0 === e && oSpP.sendPromptStat("prompt_closed"),
        document.getElementsByClassName(Y + "-prompt").length > 0 &&
          document.body.removeChild(
            document.querySelector("." + Y + "-prompt"),
          ),
        document.getElementsByClassName(Y + "-prompt-backdrop").length > 0 &&
          document.body.removeChild(
            document.querySelector("." + Y + "-prompt-backdrop"),
          ),
        oSpP.initCustomCloseEvent(),
    ...
    (this.sendUpdatesToServer = function (e) {
      ...
      var i = {
        ...
        appkey: g,
        sPushHostHash: r,
        custom_data: { variables: A },
      };
      (oSpP.initCustomSubmitEvent(), o.send(JSON.stringify(i)));
    }),
      ...
      if (J) {
        ...
        if (((i.os = t.getOS().name), void 0 !== V && 0 == V && (e = !1), e)) {
          ...
          if (document.getElementsByClassName(Y + "-backdrop-info").length) {
            if (
              (r.setAttribute("class", Y + "-bottom-push-label " + Y + "-show"),
              (r.innerHTML += s),
              "chrome" === i.name.toLowerCase() &&
                !document.getElementsByClassName(Y + "-hint-popover").length)
            ) {
              var n = this.getPushHintDiv();
              document
                .getElementsByClassName(Y + "-backdrop-info")[0]
                .appendChild(n);
            }
            document
              .getElementsByClassName(Y + "-backdrop-info")[0]
            ...
            (r.setAttribute("style", "display:none"),
              r.setAttribute(
                "class",
                Y + "-webpush-label " + p + " " + c + " " + a + " " + l,
              ),
              r.setAttribute("onclick", "this.remove();"));
            var d = document.createElement("div");
            if (
              (d.setAttribute("class", Y + "-inner-content"),
              (d.innerHTML += s),
              "chrome" === i.name.toLowerCase())
            ) {
          ...
          setTimeout(function () {
            if (null !== document.querySelector("." + Y + "-webpush-label")) {
              ...
              e.setAttribute(
                "class",
                e.getAttribute("class") + " " + Y + "-show",
              );
            }
            oSpP.initCustomShowEvent();
          }, 1e3);
        }
      }
    }),
    (this.getPushHintDiv = function () {
      ...
      (s.setAttribute("class", Y + "-cell"), (s.innerHTML += Z[e]));
      ...
      return (
        p.setAttribute("class", Y + "-prompt-message-text"),
        (p.innerHTML = Q[e]),
        i.appendChild(r),
        i.appendChild(p),
        t.appendChild(i),
    ...
    (this.showCustomPrompt = function () {
      ...
      if (
        ...
        (i = (e = JSON.parse(b)).style) === Y + "-popover" &&
          (i = Y + "-native-popover");
        ...
        if (
          (S.setAttribute("class", Y + "-bell-icon"),
        ...
        if (i === Y + "-native-popover") {
          ((r = r + "color: " + e.textcolor + " !important;"),
            ...
            void 0 !== e.custom &&
              ...
              ((u += " " + Y + "-pos-" + e.custom.prompt_position),
              l.setAttribute("class", u)),
            (x = document.createElement("div")).setAttribute(
              "class",
              Y + "-native-info-inner " + Y + "-table-wrapper",
            ));
          ...
          (M.setAttribute(
            "class",
            Y + "-prompt-info " + Y + "-prompt-message-text",
          ),
            (M.innerHTML += w),
            f.appendChild(M),
            x.appendChild(v),
          ...
          ((x = document.createElement("div")).setAttribute(
            ...
            x.setAttribute("style", "color: " + e.textcolor + " !important;"),
            (x.innerHTML += w));
          ...
          if (
            ((x = document.createElement("div")).setAttribute(
              "class",
              Y + "-prompt-title " + Y + "-prompt-message-text",
            ),
            ...
            ((I = null),
              ...
              x.setAttribute("class", Y + "-table-wrapper"));
            ...
            (L.setAttribute("class", Y + "-prompt-label"),
              (O = document.createElement("a")).setAttribute("href", B),
              O.setAttribute("target", "_blank"),
          ...
          void 0 !== e.custom &&
            void 0 !== e.custom.prompt_position &&
            ((u += " " + Y + "-fab-" + e.custom.prompt_position),
            l.setAttribute("class", u));
        ...
        (j.setAttribute(
          "class",
          Y + "-prompt-btn " + Y + "-accept-btn " + Y + "_notify_prompt",
        ),
        ...
        if (
          (k.setAttribute("class", Y + "-prompt-btn " + Y + "-disallow-btn"),
          ...
          i == Y + "-fab"
            ? (j.setAttribute("style", "display: block !important"),
              k.setAttribute("style", "display: block !important"),
              j.setAttribute(
                "style",
                "background-color:" +
                  e.buttoncolor +
          ...
          (U.setAttribute("class", Y + "-cell"), U.appendChild(k));
          ...
          i !== Y + "-fab"
            ...
            : (d.appendChild(E),
              void 0 !== e.custom.prompt_size && "big" === e.custom.prompt_size
                ? (l.appendChild(d), s && void 0 !== L && l.appendChild(L))
                : (s && void 0 !== m && E.appendChild(m),
                  l.appendChild(d),
                  l.appendChild(N))),
          i != Y + "-fab")
        ) {
    ...
    (this.closeCustomPrompt = function (e) {
      (oSpP.sendPromptStat("prompt_closed"),
        null !== document.body.querySelector("." + Y + "-prompt") &&
          document.body.querySelector("." + Y + "-prompt").remove(),
        oSpP.closePromptHelpText(!0),
        e || oSpP.putValueToDb("SPIDs", { type: "PromptClosed", value: j }),
        oSpP.initCustomCloseEvent());
    }),
    ...
    (this.hideHintDiv = function () {
      document.getElementsByClassName(Y + "-hint-popover").length &&
        document.querySelector("." + Y + "-hint-popover").remove();
    }),
    (this.closePromptHelpText = function (e) {
      (null !== document.querySelector("." + Y + "-backdrop-info") &&
        document.querySelector("." + Y + "-backdrop-info").remove(),
        e
          ? oSpP.sendPromptStat("prompt_closed")
          : oSpP.putValueToDb("SPIDs", { type: "PromptClosed", value: j }));
    }),
    (this.closePushLabel = function () {
      (null !== document.querySelector("." + Y + "-bottom-push-label") &&
        document.querySelector("." + Y + "-bottom-push-label").remove(),
        null !== document.querySelector("." + Y + "-webpush-label") &&
          document.querySelector("." + Y + "-webpush-label").remove());
    }),
    ...
    (this.initCustomShowEvent = function () {
      let e = document.querySelector(".sp-prompt")
          ? document.querySelector(".sp-prompt")
          : document.getElementsByTagName("body")[0],
        t = new CustomEvent(`${Y}PromptShowEvent`, {
          detail: {
            promptTitle: h,
            currentDate: q,
            type: "promptShown",
    ...
    (this.initCustomCloseEvent = function () {
      let e = document.querySelector(".sp-prompt")
          ? document.querySelector(".sp-prompt")
          : document.getElementsByTagName("body")[0],
        t = new CustomEvent(`${Y}PromptCloseEvent`, {
          detail: {
            promptTitle: h,
            currentDate: q,
            type: "promptClose",
    ...
    (this.initCustomSubmitEvent = function () {
      let e = document.querySelector(".sp-prompt")
          ? document.querySelector(".sp-prompt")
          : document.getElementsByTagName("body")[0],
        t = new CustomEvent(`${Y}PromptSubmitEvent`, {
          detail: {
            promptTitle: h,
            currentDate: q,
            type: "promptSubmit",
